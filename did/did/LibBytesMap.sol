...
library LibBytesMap {
    ...
    function getKey(Map storage map, uint256 index)
        internal
        view
    ...
    function getValue(Map storage map, bytes memory key)
        internal
        view
        returns (bytes memory)
    {
    ...
    function can_iterate(Map storage self, uint256 idx)
        internal
        view
        returns (bool)
    {
    ...
    function iterate_next(Map storage self, uint256 idx)
        internal
        pure
        returns (uint256)
    {
    ...
    function getKeyByIndex(Map storage map, uint256 idx)
        internal
        view
        returns (bytes memory)
    {
